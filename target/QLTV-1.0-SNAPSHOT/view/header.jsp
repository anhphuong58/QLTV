<%@page import="com.example.qltv.Bean.User" %>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    ...
                    <a href="#" class="d-block"><%=user.getUsername()%>
                    </a>
                </div>
                <%
                } else {
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column"
                    ...
                    <li
                            class="nav-item has-treeview  <c:if test="${sessionScope.Check.toString().equals('ManageReader_0') || sessionScope.Check.toString().equals('AddReader') || sessionScope.Check.toString().equals('ManageReader_1')}">menu-open</c:if>">
                        <a
                                href="#"
